...
public class UsageHelperTest {
	...
	private Collection<String> USAGE_LIST = Arrays.asList("getAddress(\"bob\")", "getVersion()", "addAddress(\"bob\", \"bob's address\")");
	private Collection<String> USAGE_METHOD_LIST = Arrays.asList("getAddress()", "getVersion()", "addAddress()");
