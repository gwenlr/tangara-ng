...
public final class UsageHelper {
	 ...
	 * { ... } </blockquote> the returned string will be
	...
	/**
	 * Find and format the list of the method name annotated with {@link Usage}
	 * of an object
	 * <p>
	 ...
	 * <p>
	 * The result returns by the method is a list of strings. Each string is a
	 * method name followed by '()'. For instance, if the following method is
	 * declared: <blockquote> <code>@Usage("\"Bob\")</code> String
	 * getAddress(String name) { ... } </blockquote> the returned string will be
	...
	/**
	 * Find and provides the list of the methods annotated with {@link Usage}
	 * and their usage samples.
	 * <p>
	 ...
	 * declared: <blockquote> <code>@Usage("\"Bob\")</code> String
	 * getAddress(String name) { ... } </blockquote> the returned entry will be
	 * {<code>getAddress()</code>, <code>getAddress("Bob")</code>
	 * </p>
	 * 
	 * @param clazz
	 *            the class to parse
