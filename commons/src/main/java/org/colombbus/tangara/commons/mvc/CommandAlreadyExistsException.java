...
/**
 * Throw when trying to create a display command which already exists
 * 
 * @author gwen
 */
...
public class CommandAlreadyExistsException extends RuntimeException {
	...
	public CommandAlreadyExistsException(Throwable cause) {
		super(cause);
	}

	public CommandAlreadyExistsException(String message, Throwable cause) {
		super(message, cause);
	}
